...
import LoginController from "./chp09/ex2/LoginControl";
import MainPageWarning from "./chp09/ex3/MainPageWarning";

import "./chp09/ex3/MainPage_style.css";
import "./chp09/closing_ex/LandingPage";

import SimpleCounter from "./practice/SimpleCounter";
import LandingPage from "./chp09/closing_ex/LandingPage";


const root = ReactDOM.createRoot(document.getElementById('root'));

// chp04 clock 실행할 때 한정
// setInterval(() => {
